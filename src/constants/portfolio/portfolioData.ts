        ...
        detailList: [
          {
            ...
            images: [
              {
                src: '/imgs/portfolio/common/commercial/item001.png',
                alt: '포트폴리오 상세 예제 이미지1',
              },
              {
                src: '/imgs/portfolio/common/commercial/item002.png',
                alt: '포트폴리오 상세 예제 이미지2',
              },
              {
                src: '/imgs/portfolio/common/commercial/item003.png',
                alt: '포트폴리오 상세 예제 이미지3',
              },
              {
                src: '/imgs/portfolio/common/commercial/item004.png',
                alt: '포트폴리오 상세 예제 이미지4',
              },
              {
                src: '/imgs/portfolio/common/commercial/item005.png',
        ...
        detailList: [
          {
            ...
            images: [
              {
                src: '/imgs/portfolio/common/residential/item001.png',
                alt: '현관문',
              },
            ],
          },
          {
            ...
            images: [
              {
                src: '/imgs/portfolio/common/residential/item002.png',
                alt: '안방',
              },
            ],
          },
          {
            ...
            images: [
              {
                src: '/imgs/portfolio/common/residential/item003.png',
                alt: '아일랜드 식탁',
              },
              {
                src: '/imgs/portfolio/common/residential/item004.png',
                alt: '씽크대',
              },
            ],
          },
